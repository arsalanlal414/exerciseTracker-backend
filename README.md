...
1. Clone the repository: `git clone https://github.com/arsalanlal414/exerciseTracker-backend.git`
...
5. Open your browser and navigate to `http://localhost:5001` to access the app.
